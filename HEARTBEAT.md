...
- Consultation Center prompt tetigi self-call lock hatasindan cikarildi; prompt hazirlama artik ayrik `esnafdijital` agent uzerinden kosuyor ve ayni session lock ile dusmuyor
...
- README ve AGENTS tarafina, giris rotasini bozmadan, OpenClaw davranis/runtime degisiklikleri icin kisa dis referans notu eklendi
