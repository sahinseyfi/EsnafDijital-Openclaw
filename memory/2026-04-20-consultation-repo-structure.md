...
HEARTBEAT.md açıkça kısa ömürlü operasyon nabzı için. MEMORY.md ise kalıcı gerçekler için. Ama aynı kökte NOTES.md, eski-danisma-logu, BOOTSTRAP.md, HEARTBEAT.json, DEGISIKLIK_OZETI.md gibi geçicilik derecesi farklı başka dosyalar da duruyor. Bu karışım, “güncel olan ne, tarihi olan ne, kalıcı olan ne?” ayrımını zayıflatıyor. ￼
