...
HEARTBEAT.md açıkça kısa ömürlü operasyon nabzı için. MEMORY.md ise kalıcı gerçekler için. Ama aynı kökte NOTES.md, eski-danisma-logu, BOOTSTRAP.md, yan heartbeat JSON ozeti, DEGISIKLIK_OZETI.md gibi geçicilik derecesi farklı başka dosyalar da duruyor. Bu karışım, “güncel olan ne, tarihi olan ne, kalıcı olan ne?” ayrımını zayıflatıyor. ￼
...
HEARTBEAT.md ve yan heartbeat JSON ozeti aynı alanı iki formatta taşıyor. Bu faydalı olabilir; ama biri ana, diğeri türetilmiş olarak tanımlanmazsa güven düşer. ￼
...
├─ yan heartbeat JSON ozeti # makine için türetilmiş özet
...
* Danışma geçmişi → context/logs/eski-danisma-logu
...
* HEARTBEAT.md ana kaynaktır; yan heartbeat JSON ozeti ondan türetilir.
...
* eski-danisma-logu → context/logs/eski-danisma-logu
...
* yan heartbeat JSON ozeti türev
