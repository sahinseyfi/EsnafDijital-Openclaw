...
- **Yeni kaynak kod için önerilen çalışma yolu:** `/root/.openclaw/workspace/web`
- **Admin statik sayfa kaynak yolu:** `/root/.openclaw/workspace/admin-site`
- **Admin statik yayın yolu:** `/opt/esnafdijital/admin-site`
...
- **Admin domain durumu:** `admin.esnafdijital.com.tr` için Caddy hazır, DNS A kaydı henüz yok
