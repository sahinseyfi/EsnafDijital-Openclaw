...
2. Gorevi guvenle kurmak icin gereken baglami sec.
   ...
   - Eger hedef dis GPT oturumuysa ve gorev repo analizi gerektiriyorsa, final promptu okuyacak dis GPT'yi repo icerigini gercekten incelemeye yonlendir. Bunu ilgili dosya, link, archive veya erisilebilen baska repo icerigi uzerinden yapsin. Bu da mumkun degilse blokaji acik yazsin.
...
- Dis GPT oturumunda repo analizi gerekiyorsa, final promptta repo inceleme gorevini bizim ajana degil dis GPT'ye ver. Yalnizca promptta verilen kisa ozetle yetinme; dis GPT'yi repo icerigini gercekten incelemeye yonlendir.
